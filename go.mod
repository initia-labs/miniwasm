...
require (
	...
	github.com/initia-labs/initia v0.2.4-0.20240417075658-bce603fc65c1
...
replace (
	...
	github.com/cosmos/ibc-go/v8 => github.com/initia-labs/ibc-go/v8 v8.0.0-20240413052354-077439b8bed3
