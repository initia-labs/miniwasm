...
import (
	...
	v1_3_0 "github.com/initia-labs/miniwasm/app/upgrades/v1_3_0"
...
func NewMinitiaApp(
	...
	// setup ABCIPP
	mempool, anteHandler, prepareProposalHandler, processProposalHandler, checkTx, err := app.setupABCIPP(mempoolMaxTxs, wasmConfig, app.GetKVStoreKey()[wasmtypes.StoreKey], appOpts)
	if err != nil {
		tmos.Exit(err.Error())
	}
