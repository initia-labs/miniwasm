...
func init() {
	...
	md_DenomAuthorityMetadata = File_miniwasm_tokenfactory_v1_authorityMetadata_proto.Messages().ByName("DenomAuthorityMetadata")
...
func (x *DenomAuthorityMetadata) slowProtoReflect() protoreflect.Message {
	mi := &file_miniwasm_tokenfactory_v1_authorityMetadata_proto_msgTypes[0]
...
// 	protoc        (unknown)
// source: miniwasm/tokenfactory/v1/authorityMetadata.proto
...
func (*DenomAuthorityMetadata) Descriptor() ([]byte, []int) {
	return file_miniwasm_tokenfactory_v1_authorityMetadata_proto_rawDescGZIP(), []int{0}
}
...
var File_miniwasm_tokenfactory_v1_authorityMetadata_proto protoreflect.FileDescriptor

var file_miniwasm_tokenfactory_v1_authorityMetadata_proto_rawDesc = []byte{
	0x0a, 0x30, 0x6d, 0x69, 0x6e, 0x69, 0x77, 0x61, 0x73, 0x6d, 0x2f, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	...
	0x74, 0x6f, 0x12, 0x18, 0x6d, 0x69, 0x6e, 0x69, 0x77, 0x61, 0x73, 0x6d, 0x2e, 0x74, 0x6f, 0x6b,
	...
	0x6f, 0x6d, 0x2e, 0x6d, 0x69, 0x6e, 0x69, 0x77, 0x61, 0x73, 0x6d, 0x2e, 0x74, 0x6f, 0x6b, 0x65,
...
var (
	file_miniwasm_tokenfactory_v1_authorityMetadata_proto_rawDescOnce sync.Once
	file_miniwasm_tokenfactory_v1_authorityMetadata_proto_rawDescData = file_miniwasm_tokenfactory_v1_authorityMetadata_proto_rawDesc
)

func file_miniwasm_tokenfactory_v1_authorityMetadata_proto_rawDescGZIP() []byte {
	file_miniwasm_tokenfactory_v1_authorityMetadata_proto_rawDescOnce.Do(func() {
		file_miniwasm_tokenfactory_v1_authorityMetadata_proto_rawDescData = protoimpl.X.CompressGZIP(file_miniwasm_tokenfactory_v1_authorityMetadata_proto_rawDescData)
	})
	return file_miniwasm_tokenfactory_v1_authorityMetadata_proto_rawDescData
}

var file_miniwasm_tokenfactory_v1_authorityMetadata_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_miniwasm_tokenfactory_v1_authorityMetadata_proto_goTypes = []interface{}{
	(*DenomAuthorityMetadata)(nil), // 0: miniwasm.tokenfactory.v1.DenomAuthorityMetadata
}
var file_miniwasm_tokenfactory_v1_authorityMetadata_proto_depIdxs = []int32{
...
func init() { file_miniwasm_tokenfactory_v1_authorityMetadata_proto_init() }
func file_miniwasm_tokenfactory_v1_authorityMetadata_proto_init() {
	if File_miniwasm_tokenfactory_v1_authorityMetadata_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_miniwasm_tokenfactory_v1_authorityMetadata_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_miniwasm_tokenfactory_v1_authorityMetadata_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_miniwasm_tokenfactory_v1_authorityMetadata_proto_goTypes,
		DependencyIndexes: file_miniwasm_tokenfactory_v1_authorityMetadata_proto_depIdxs,
		MessageInfos:      file_miniwasm_tokenfactory_v1_authorityMetadata_proto_msgTypes,
	}.Build()
	File_miniwasm_tokenfactory_v1_authorityMetadata_proto = out.File
	file_miniwasm_tokenfactory_v1_authorityMetadata_proto_rawDesc = nil
	file_miniwasm_tokenfactory_v1_authorityMetadata_proto_goTypes = nil
	file_miniwasm_tokenfactory_v1_authorityMetadata_proto_depIdxs = nil
}
