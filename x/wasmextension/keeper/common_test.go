...
func _createTestInput(
	...
	keys := storetypes.NewKVStoreKeys(
		...
		distributiontypes.StoreKey, wasmtypes.StoreKey, opchildtypes.StoreKey,
	)
	...
	cac := authcodec.NewBech32Codec(sdk.GetConfig().GetBech32ConsensusAddrPrefix())
